...
const AdminLogin = (props: Props) => {
  ...
  // const { token, currentUser, setToken, setCurrentUser, setRole } = useAppContext();
  ...
  useEffect(() => {
    if (isSuccess) {
      ...
      if (data?.data?.user?.role === "admin") {
        ...
        toast.error("You are not allowed", { id: "admin-login" });
        handleLogout();
        navigate("/login");
      }
    }
      ...
      <div className="md:flex h-screen">
        <div className="relative overflow-hidden h-screen lg:flex flex-1 bg-gradient-to-tr from-blue-800 to-purple-700 i justify-around items-center hidden">
          <div>
            ...
            <p className="text-white mt-2 text-3xl font-mono font-medium">
              Admin Login
            </p>
